...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'module.module': {
            'Meta': {'object_name': 'Module', 'db_table': "'cmsplugin_module'", '_ormbases': ['cms.CMSPlugin']},
